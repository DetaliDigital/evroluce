$(document).ready(function() {
        $(".mvtFormsOneClickForm").click(function(e) {
            ...
            var t = $(this).attr("id") + "_result",
                a = $(this).attr("id");
            $("#" + t).html('<img class="loading" src="assets/components/mvtforms/img/loading.gif" style="width:50px;">');
